local utils = require("sijink.utils")
...
return {
  ...
  config = function()
    local notes_path = utils.env_or_default("NEORG_NOTES_WORKSPACE_DIR", "~/Notes")
    local worknotes_path = utils.env_or_default("NEORG_WORKNOTES_WORKSPACE_DIR", "~/Worknotes")
    require("neorg").setup({
      load = {
