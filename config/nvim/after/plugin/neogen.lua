...
vim.keymap.set(
  ...
  make_opts("Generate function annotation")
)
vim.keymap.set(
  "n",
  "<leader>xc",
  ":lua require('neogen').generate({ type = 'class'})<CR>",
  make_opts("Generate class annotation")
)
vim.keymap.set(
  "n",
  "<leader>xt",
  ":lua require('neogen').generate({ type = 'type'})<CR>",
  make_opts("Generate type annotation")
)
vim.keymap.set(
  "n",
  "<leader>xF",
  ":lua require('neogen').generate({ type = 'file'})<CR>",
  make_opts("Generate file annotation")
)
